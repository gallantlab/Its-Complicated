...
To make one point clear: this is still orders of magnitude more complicated than an experiment in, say, PsychoPy. What this guide and codebase does, however, is to turn what might seem impossible into merely difficult.
